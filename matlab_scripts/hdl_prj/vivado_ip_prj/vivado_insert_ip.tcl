...
update_ip_catalog -delete_ip {./ipcore/dvfs_core_ip_v1_0/component.xml} -repo_path {./ipcore} -quiet
update_ip_catalog -add_ip {./ipcore/dvfs_core_ip_v1_0.zip} -repo_path {./ipcore}
update_ip_catalog
set HDLCODERIPVLNV [get_property VLNV [get_ipdefs -filter {NAME==dvfs_core_ip && VERSION==1.0}]]
set HDLCODERIPINST dvfs_core_ip_0
...
set TOPFILEPATH "./vivado_prj.gen/sources_1/bd/system_top/hdl/system_top_wrapper.v"
