...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net sys_core_clk [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins axi_cpu_interconnect/M01_ACLK] [get_bd_pins core_clkwiz/clk_out1] [get_bd_pins sys_core_rstgen/slowest_sync_clk]
  connect_bd_net -net sys_core_resetn [get_bd_pins axi_cpu_interconnect/M00_ARESETN] [get_bd_pins axi_cpu_interconnect/M01_ARESETN] [get_bd_pins sys_core_rstgen/peripheral_aresetn]
