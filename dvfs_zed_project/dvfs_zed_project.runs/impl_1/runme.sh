...
HD_PWD='C:/projects/dvfs_zed/dvfs_zed_project/dvfs_zed_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dvfs_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dvfs_bd_wrapper.tcl -notrace
