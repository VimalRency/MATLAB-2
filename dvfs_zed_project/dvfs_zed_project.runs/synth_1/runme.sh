...
HD_PWD='C:/projects/dvfs_zed/dvfs_zed_project/dvfs_zed_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dvfs_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dvfs_bd_wrapper.tcl
