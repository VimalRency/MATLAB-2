...
HD_PWD='C:/projects/dvfs_zed/dvfs_zed_project/dvfs_zed_project.runs/dvfs_bd_dvfs_core_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dvfs_bd_dvfs_core_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dvfs_bd_dvfs_core_ip_0_0.tcl
